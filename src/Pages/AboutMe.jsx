				...
				<div className="flex flex-col md:flex-row ">
					...
					<div className="md:w-full flex flex-col justify-between">
						<p
							...
							Saya adalah Fajar Irwansah, seorang siswa yang menekuni bidang Teknik Informatika
							 dengan fokus pada pengembangan front-end web, Software Enginer, dan Web Developer. Saya memiliki tekad yang kuat
							...
							memiliki minat besar di bidang front-end web, Web Developer, dan Software Enginer.
						</p>
